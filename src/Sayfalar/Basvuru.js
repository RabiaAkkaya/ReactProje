    ...
    return (
            ...
            <div class="row">
                ...
                <div class="row mx-auto mb-4">
                        ...
                        <input type="text" class="form-control py-2 mb-4" id="Ad" placeholder="İsim Giriniz" />
                        <input type="text" class="form-control py-2 mb-4" id="SoyAd" placeholder="Soyad Giriniz" />
                        <div class="col-12">
                        ...
                        <h7 class="form-control mb-2">
                            ...
                            <input type="text" class="form-control py-2 mb-2" style={{ display: "none" }} id="uyruk3" placeholder="Uyruk Giriniz" />
                            <input type="text" class="form-control py-2 mb-4" style={{ display: "none" }} id="IDnumber3" placeholder="ID Number Giriniz" />
                            <div class="row">
                                <div class="col-4"></div>
                                <div class="col-4 md-2"> <button type="button" class="btn btn-dark mb-2 " id="uyruk_btn" onclick="uyrukArttir()"> Farklı uyruk bilgisi için tıklayınız.</button></div>
                                <div class="col-4"></div>
                        ...
                        <div class="col-12 ">
                            <select class="form-select form-select-sm-1 py-2 mb-4" aria-label=".form-select-sm example" id="engelslct" onchange="engel()">
                            ...
                            <div class="col-2" style={{width:"100px",height:"100px", backgroundImage:`url(${buttonright})`}} onClick={()=>goster("Basvuru2")}></div>
                            </div>
